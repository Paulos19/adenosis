...
import { Home, BookOpen, BarChart3, Settings, Palette, ShoppingCart, UploadCloud } from "lucide-react";
...
const dashboardLinks = [
  ...
  { href: "/dashboard/books/import", label: "Importar Livros", icon: UploadCloud },
